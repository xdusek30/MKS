...
static const uint32_t reg_values[4][10] =
{
	 ...
	 0b0000001100000000 << 16,  // 1+2
	 0b0000011100000000 << 16,  // 1+2+3
	 0b0000111100000000 << 16, //1+2+3+4
	 0b0000111110000000 << 16, // 1+2+3+4+5
	 0b0000111111000000 << 16,  // 1+2+3+4+5+6
	 0b0000111111100000 << 16,  // 1+2+3+4+5+6+7
	 0b0000111111110000 << 16,  // 1+2+3+4+5+6+8
	 },
